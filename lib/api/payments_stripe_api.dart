...
class PaymentsStripeApi {
  ...
  Future<PaymentMethodResource> createCustomerUsingPOST1({ StripeCreatePaymentMethod request }) async {
  ...
  ///
  /// 
  Future payInvoiceUsingPOST1({ StripePaymentRequest request }) async {
    Object postBody = request;
