...
> PageResource«TemplateResource» getArticleTemplatesUsingGET(size, page, order)
...
# **getArticlesUsingGET**
> PageResource«ArticleResource» getArticlesUsingGET(filterCategory, filterTagset, filterTitle, size, page, order)
