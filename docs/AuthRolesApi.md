...
try { 
    api_instance.setClientRoles(clientKey, rolesList);
} catch (e) {
...
try { 
    api_instance.setPermissionsForRole(role, permissionsList);
} catch (e) {
...
try { 
    api_instance.setUserRoles(userId, rolesList);
} catch (e) {
...
try { 
    api_instance.updateRole(role, roleResource);
} catch (e) {
