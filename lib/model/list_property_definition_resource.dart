...
/* If provided, a property definition for validating values within list */
  ...
  @override
  String toString()  {
    return 'ListPropertyDefinitionResource[fieldList=$fieldList, name=$name, required=$required, type=$type, maxCount=$maxCount, minCount=$minCount, valueDefinition=$valueDefinition, ]';
  }
