...
> PageResource«BreEventLog» getEventsLogsUsingGET(filterStartDate, filterEventName, size, page, order)
...
> PageResource«ForwardLog» getForwardLogsUsingGET(filterStartDate, filterEndDate, filterStatusCode, size, page, order)
...
> PageResource«UserActionLog» getUserLogsUsingGET1(filterUser, filterActionName, size, page)
