...
class StoreCouponsApi {
  ...
  Future<CouponItem> createCouponItem({ CouponItem couponItem }) async {
  ...
  ///
  /// 
  Future updateCouponItem(int id, { CouponItem couponItem }) async {
    Object postBody = couponItem;
  ...
  ///
  /// 
  Future updateCouponTemplate(String id, { ItemTemplateResource couponTemplateResource }) async {
    Object postBody = couponTemplateResource;
