# swagger.api.Reporting_UsageApi
...
var api_instance = new Reporting_UsageApi();
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageByDay: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageByHour: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageByMinute: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageByMonth: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageByYear: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Reporting_UsageApi->getUsageEndpoints: $e\n");
}
```
