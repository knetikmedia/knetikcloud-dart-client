...
class PaymentsWalletsApi {
  ...
  ///
  /// 
  Future<Page«WalletTotalResponse»> getWalletTotalsUsingGET() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«WalletTotalResponse»') as Page«WalletTotalResponse» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<SimpleWallet> getWalletUsingGET(int userId, String currencyCode) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<List<SimpleWallet>> getWalletsUsingGET(int userId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«SimpleWallet»> getWalletsUsingGET1({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«SimpleWallet»') as Page«SimpleWallet» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«WalletTransactionResource»> transactionHistoryUsingGET({ int filterInvoice, String filterType, int filterMaxDate, int filterMinDate, String filterSign, int filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«WalletTransactionResource»') as Page«WalletTransactionResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<WalletTransactionResource> updateBalanceUsingPUT(int userId, String currencyCode, { WalletAlterRequest request }) async {
  ...
  ///
  /// 
  Future<Page«WalletTransactionResource»> userTransactionHistoryUsingGET(int userId, String currencyCode, { String filterType, int filterMaxDate, int filterMinDate, String filterSign, int size, int page, String order }) async {
    Object postBody = null;
