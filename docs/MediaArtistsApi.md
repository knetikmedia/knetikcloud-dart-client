...
> PageResource«TemplateResource» getArtistTemplatesUsingGET(size, page, order)
...
> PageResource«ArtistResource» searchArtistsUsingGET(filterArtistsByName, size, page, order)
