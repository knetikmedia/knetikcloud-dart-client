...
class GamificationTriviaApi {
  ...
  ///
  /// 
  Future<AnswerResource> addAnswersUsingPOST(String questionId, { AnswerResource answer }) async {
  ...
  ///
  /// 
  Future addTagUsingPOST(String id, { String tag }) async {
    Object postBody = tag;
  ...
  Future<int> batchAddTagUsingPOST({ String tag, String filterSearch, String filterIdset, String filterCategory, String filterTag, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
    Object postBody = tag;
  ...
  Future<int> batchRemoveTagUsingDELETE(String tag, { String filterSearch, String filterIdset, String filterCategory, String filterTag, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
  ...
  Future<int> bulkUpdateUsingPUT({ QuestionResource question, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
  ...
  Future<int> countQuestionsUsingGET({ String filterSearch, String filterIdset, String filterCategory, String filterTag, String filterTagset, String filterType, bool filterPublished }) async {
    Object postBody = null;
  ...
  Future<QuestionTemplateResource> createQuestionTemplateUsingPOST({ QuestionTemplateResource questionTemplateResource }) async {
  ...
  ///
  /// 
  Future<QuestionResource> createQuestionUsingPOST({ QuestionResource question }) async {
    Object postBody = question;
  ...
  Future<ImportJobResource> createUsingPOST({ ImportJobResource request }) async {
  ...
  Future deleteQuestionTemplateUsingDELETE(String id, { String cascade }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future deleteQuestionUsingDELETE(String id) async {
    Object postBody = null;
  ...
  Future deleteUsingDELETE(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<AnswerResource> getAnswerUsingGET(String questionId, String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<List<AnswerResource>> getAnswersUsingGET(String questionId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«ImportJobResource»> getListUsingGET1({ String filterVendor, String filterCategory, String filterName, String filterStatus, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«ImportJobResource»') as Page«ImportJobResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<QuestionTemplateResource> getQuestionTemplateUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«QuestionTemplateResource»> getQuestionTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«QuestionTemplateResource»') as Page«QuestionTemplateResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<QuestionResource> getQuestionUsingGET(String id) async {
    Object postBody = null;
  ...
  Future<List<DeltaResource>> getQuestionsDeltaUsingGET({ int since }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«QuestionResource»> getQuestionsUsingGET({ int size, int page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«QuestionResource»') as Page«QuestionResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<List<String>> getTagsUsingGET1(String id) async {
    Object postBody = null;
  ...
  Future<Collection«string»> getTagsUsingGET2({ String filterSearch, String filterCategory, int filterImportId }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Collection«string»') as Collection«string» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<ImportJobResource> getUsingGET(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future removeAnswersUsingDELETE(String questionId, String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future removeTagUsingDELETE(String id, String tag) async {
    Object postBody = null;
  ...
  Future<ImportJobResource> startProcessUsingPOST(int id, bool publishNow) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateAnswerUsingPUT(String questionId, String id, { AnswerResource answer }) async {
    Object postBody = answer;
  ...
  ///
  /// 
  Future updateQuestionTemplateUsingPUT(String id, { QuestionTemplateResource questionTemplateResource }) async {
    Object postBody = questionTemplateResource;
  ...
  ///
  /// 
  Future<QuestionResource> updateQuestionUsingPUT(String id, { QuestionResource question }) async {
    Object postBody = question;
  ...
  Future<ImportJobResource> updateUsingPUT(int id, { ImportJobResource request }) async {
    Object postBody = request;
