...
class ReportingUsageApi {
  ...
  ///
  /// 
  Future<Page«UsageInfo»> getUsageByDayUsingGET(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«UsageInfo»') as Page«UsageInfo» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«UsageInfo»> getUsageByHourUsingGET(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«UsageInfo»> getUsageByMinuteUsingGET(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«UsageInfo»> getUsageByMonthUsingGET(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«UsageInfo»> getUsageByYearUsingGET(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
