...
class MessagingApi {
  ...
  ///
  /// 
  Future sendRawEmailUsingPOST({ RawEmailResource rawEmailResource }) async {
  ...
  Future sendRawSMSUsingPOST({ RawSMSResource rawSMSResource }) async {
  ...
  Future sendRawSMSUsingPOST1({ TemplateSMSResource templateSMSResource }) async {
  ...
  ///
  /// 
  Future sendTemplateEmailUsingPOST({ TemplateEmailResource messageResource }) async {
