...
class CampaignsApi {
  ...
  ///
  /// 
  Future<PageResource«ChallengeResource»> getCampaignChallenges(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateCampaign(int id, { CampaignResource campaignResource }) async {
    Object postBody = campaignResource;
  ...
  ///
  /// 
  Future updateCampaignTemplate(String id, { TemplateResource campaignTemplateResource }) async {
    Object postBody = campaignTemplateResource;
