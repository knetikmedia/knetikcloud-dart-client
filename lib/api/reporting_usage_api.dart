...
class ReportingUsageApi {
  ...
  ///
  /// 
  Future<PageResource«UsageInfo»> getUsageByDay(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
  ...
  ///
  /// 
  Future<PageResource«UsageInfo»> getUsageByHour(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UsageInfo»> getUsageByMinute(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UsageInfo»> getUsageByMonth(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UsageInfo»> getUsageByYear(int startDate, int endDate, { bool combineEndpoints, int size, int page }) async {
    Object postBody = null;
