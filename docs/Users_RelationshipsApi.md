# swagger.api.Users_RelationshipsApi
...
var api_instance = new Users_RelationshipsApi();
...
try { 
    ...
    print("Exception when calling Users_RelationshipsApi->createUserRelationship: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Users_RelationshipsApi->deleteUserRelationship: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Users_RelationshipsApi->getUserRelationship: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Users_RelationshipsApi->getUserRelationships: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Users_RelationshipsApi->updateUserRelationship: $e\n");
}
```
