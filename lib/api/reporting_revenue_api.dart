...
class ReportingRevenueApi {
  ...
  Future<PageResource«RevenueCountryReportResource»> executiveRevenueCountrySalesUsingGET(String currencyCode, { int startDate, int endDate, int size, int page }) async {
  ...
  Future<PageResource«RevenueProductReportResource»> executiveRevenueProductSalesUsingGET(String currencyCode, { int startDate, int endDate, int size, int page }) async {
    Object postBody = null;
