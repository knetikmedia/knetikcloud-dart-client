...
class TaxesApi {
  ...
  ///
  /// Get a list of taxes
  Future<PageResource«StateTaxResource»> getAllTaxesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// Get a list of taxes
  Future<PageResource«CountryTaxResource»> getTaxesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// Get a list of taxes
  Future<PageResource«StateTaxResource»> getTaxesUsingGET1(String countryCodeIso3, { int size, int page, String order }) async {
    Object postBody = null;
