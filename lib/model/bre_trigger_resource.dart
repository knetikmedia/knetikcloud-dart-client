...
/* A human readable name for this trigger */
  ...
  @override
  String toString()  {
    return 'BreTriggerResource[category=$category, eventName=$eventName, parameters=$parameters, systemTrigger=$systemTrigger, tags=$tags, triggerDescription=$triggerDescription, triggerName=$triggerName, ]';
  }
