...
class BRERuleEngineRulesApi {
  ...
  ///
  /// 
  Future<PageResource«BreRule»> getRulesUsingGET({ String filterName, bool filterEnabled, bool filterSystem, String filterTrigger, String filterAction, String filterCondition, int size, int page }) async {
    Object postBody = null;
