...
class UsersApi {
  ...
  ///
  /// Additional private info is included as USERS_ADMIN
  Future<Page«UserBaseResource»> getUsersUsingGET({ String filterRole, String filterDisplayname, String filterEmail, String filterFirstname, String filterFullname, String filterLastname, String filterUsername, int size, int page, String order }) async {
    Object postBody = null;
