...
/* If provided, the minimum length of the audio */
  ...
  @override
  String toString()  {
    return 'AudioPropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, fileType=$fileType, maxLength=$maxLength, minLength=$minLength, ]';
  }
