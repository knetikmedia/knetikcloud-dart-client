...
# **getAllTaxesUsingGET**
> Page«StateTaxResource» getAllTaxesUsingGET(size, page, order)
...
[**Page«StateTaxResource»**](Page«StateTaxResource».md)
...
# **getTaxesUsingGET**
> Page«CountryTaxResource» getTaxesUsingGET(size, page, order)
...
[**Page«CountryTaxResource»**](Page«CountryTaxResource».md)
...
# **getTaxesUsingGET1**
> Page«StateTaxResource» getTaxesUsingGET1(countryCodeIso3, size, page, order)
