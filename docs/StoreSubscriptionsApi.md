...
> Page«SubscriptionTemplateResource» getSubscriptionTemplatesUsingGET(size, page, order)
...
[**Page«SubscriptionTemplateResource»**](Page«SubscriptionTemplateResource».md)
...
try { 
    ...
    print("Exception when calling StoreSubscriptionsApi->listBillingReportsUsingGET: $e\n");
}
```
...
> Page«SubscriptionResource» listSubscriptionsUsingGET(size, page, order)
...
[**Page«SubscriptionResource»**](Page«SubscriptionResource».md)
