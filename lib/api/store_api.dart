...
class StoreApi {
  ...
  ///
  /// 
  Future<PageResource«StoreItemTemplateResource»> getItemTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«StoreItem»> getStoreItemsUsingGET({ String filterNameSearch, String filterUniqueKey, bool filterPublished, bool filterDisplayable, String filterStart, String filterEnd, String filterStartDate, String filterStopDate, String filterSku, String filterPrice, String filterTag, String filterItemsByType, String filterBundledSkus, int size, int page, String order }) async {
    Object postBody = null;
  ...
  Future<PageResource«StoreItem»> getUsingGET2({ StoreListRequest storeListRequest }) async {
