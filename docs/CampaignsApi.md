...
> Page«TemplateResource» getCampaignTemplatesUsingGET(size, page, order)
...
> Page«CampaignResource» getCampaignsUsingGET(filterActive, size, page, order)
...
[**Page«CampaignResource»**](Page«CampaignResource».md)
...
> Page«ChallengeResource» getChallengesUsingGET(id)
