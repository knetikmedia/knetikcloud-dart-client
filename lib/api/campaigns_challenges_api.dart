...
class CampaignsChallengesApi {
  ...
  ///
  /// 
  Future<Page«ChallengeEventResource»> getChallengeEventssUsingGET({ String filterStartDate, String filterEndDate, bool filterCampaigns, int filterChallenge, int size, int page, String order }) async {
    Object postBody = null;
