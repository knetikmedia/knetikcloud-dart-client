...
/* The date/time this resource was last updated in seconds since unix epoch */
  ...
  @override
  String toString()  {
    return 'ItemTemplateResource[allowAdditional=$allowAdditional, behaviors=$behaviors, createdDate=$createdDate, id=$id, name=$name, properties=$properties, updatedDate=$updatedDate, ]';
  }
