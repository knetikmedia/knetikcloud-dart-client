...
class ReportingOrdersApi {
  ...
  ///
  /// 
  Future<PageResource«AggregateInvoiceReportResource»> getInvoiceReports(String currencyCode, { String granularity, String filterPaymentStatus, String filterFulfillmentStatus, int startDate, int endDate }) async {
