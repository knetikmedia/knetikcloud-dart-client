...
class InvoicesApi {
  ...
  Future<PageResource«InvoiceResource»> getInvoices({ int filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterExternalRef, String filterCreatedDate, int size, int page, String order }) async {
    Object postBody = null;
