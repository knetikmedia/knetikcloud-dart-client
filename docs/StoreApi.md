...
var itemTemplateResource = new ItemTemplateResource(); // ItemTemplateResource | The new item template
...
> Page«ItemTemplateResource» getItemTemplatesUsingGET(size, page, order)
...
var api_instance = new StoreApi();
var id = id_example; // String | The id of the template
var itemTemplateResource = new ItemTemplateResource(); // ItemTemplateResource | The item template resource object
