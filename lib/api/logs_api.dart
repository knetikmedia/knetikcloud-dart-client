...
class LogsApi {
  ...
  ///
  /// 
  Future<PageResource«BreEventLog»> getEventsLogsUsingGET({ String filterStartDate, String filterEventName, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«ForwardLog»> getForwardLogsUsingGET({ String filterStartDate, String filterEndDate, int filterStatusCode, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserActionLog»> getUserLogsUsingGET1({ int filterUser, String filterActionName, int size, int page }) async {
    Object postBody = null;
