...
/* The vendor who provides the item */
  ...
  @override
  String toString()  {
    return 'CouponItem[additionalProperties=$additionalProperties, behaviors=$behaviors, category=$category, couponTypeHint=$couponTypeHint, createdDate=$createdDate, discountMax=$discountMax, discountMinCartValue=$discountMinCartValue, discountType=$discountType, discountValue=$discountValue, displayable=$displayable, exclusive=$exclusive, geoCountryList=$geoCountryList, geoPolicyType=$geoPolicyType, id=$id, itemId=$itemId, longDescription=$longDescription, maxQuantity=$maxQuantity, name=$name, selfExclusive=$selfExclusive, shippingTier=$shippingTier, shortDescription=$shortDescription, skus=$skus, sort=$sort, storeEnd=$storeEnd, storeStart=$storeStart, tags=$tags, template=$template, typeHint=$typeHint, uniqueKey=$uniqueKey, updatedDate=$updatedDate, validForTags=$validForTags, vendorId=$vendorId, ]';
  }
