...
part 'model/a occurrence of an activity (the actual game for example) used to track scores, participants, and provide settings.dart';
part 'model/a request to reset a user&#39;s password by using a known user property.dart';
...
part 'model/represents an activity that can be parameterized and tracked through metrics (scores, etc).dart';
...
part 'model/the definition of an activity parameters: ex: difficulty level.dart';
