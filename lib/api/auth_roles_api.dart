...
class AuthRolesApi {
  ...
  ///
  /// 
  Future assignClientRolesUsingPUT(String clientKey, { List<String> rolesList }) async {
  ...
  ///
  /// 
  Future assignPermissionsUsingPUT(String role, { List<String> permissionsList }) async {
  ...
  ///
  /// 
  Future assignUserRolesExternalUsingPUT(int userId, { List<String> rolesList }) async {
    Object postBody = rolesList;
  ...
  ///
  /// 
  Future<RoleResource> createRoleUsingPOST({ RoleResource roleResource }) async {
  ...
  ///
  /// 
  Future deleteRoleUsingDELETE(String role, { bool force }) async {
  ...
  ///
  /// 
  Future<List<RoleResource>> getClientRolesUsingGET(String clientKey) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<RoleResource> getRoleUsingGET(String role) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«RoleResource»> getRolesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«RoleResource»') as Page«RoleResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<List<RoleResource>> getUserRolesUsingGET(int userId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateRoleUsingPUT(String role, { RoleResource roleResource }) async {
    Object postBody = roleResource;
