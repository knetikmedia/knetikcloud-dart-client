...
/* The date/time this resource was last updated in seconds since unix epoch */
  ...
  @override
  String toString()  {
    return 'QuestionTemplateResource[answerProperty=$answerProperty, createdDate=$createdDate, id=$id, name=$name, properties=$properties, questionProperty=$questionProperty, updatedDate=$updatedDate, ]';
  }
