...
class GamificationTriviaApi {
  ...
  ///
  /// 
  Future<PageResource«ImportJobResource»> getListUsingGET1({ String filterVendor, String filterCategory, String filterName, String filterStatus, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«QuestionTemplateResource»> getQuestionTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«QuestionResource»> getQuestionsUsingGET({ int size, int page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
    Object postBody = null;
