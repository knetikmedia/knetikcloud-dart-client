...
class PaymentsWalletsApi {
  ...
  ///
  /// 
  Future<PageResource«WalletTotalResponse»> getWalletTotalsUsingGET() async {
  ...
  ///
  /// 
  Future<PageResource«SimpleWallet»> getWalletsUsingGET1({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«WalletTransactionResource»> transactionHistoryUsingGET({ int filterInvoice, String filterType, int filterMaxDate, int filterMinDate, String filterSign, int filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«WalletTransactionResource»> userTransactionHistoryUsingGET(int userId, String currencyCode, { String filterType, int filterMaxDate, int filterMinDate, String filterSign, int size, int page, String order }) async {
    Object postBody = null;
