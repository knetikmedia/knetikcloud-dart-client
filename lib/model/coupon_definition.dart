...
class CouponDefinition {
  ...
  @override
  String toString()  {
    return 'CouponDefinition[code=$code, description=$description, discountType=$discountType, exclusive=$exclusive, maxDiscount=$maxDiscount, maxQuantity=$maxQuantity, minCartTotal=$minCartTotal, name=$name, targetItemId=$targetItemId, type=$type, validForTags=$validForTags, value=$value, vendorId=$vendorId, ]';
  }
