...
class InvoicesApi {
  ...
  Future<PageResource«InvoiceResource»> getInvoices({ int filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterCreatedDate, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<List<String>> listFulFillmentStatuses() async {
    Object postBody = null;
