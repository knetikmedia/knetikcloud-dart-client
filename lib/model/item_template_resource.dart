...
/* The date/time this resource was last updated in seconds since unix epoch */
  ...
  @override
  String toString()  {
    return 'ItemTemplateResource[behaviors=$behaviors, createdDate=$createdDate, id=$id, name=$name, properties=$properties, skuTemplate=$skuTemplate, updatedDate=$updatedDate, ]';
  }
