...
class PaymentsPayPalClassicApi {
  ...
  Future<String> createBillingAgreementUrlUsingPOST({ CreateBillingAgreementRequest request }) async {
  ...
  Future<String> expressCheckoutUsingPOST({ CreatePayPalPaymentRequest request }) async {
    Object postBody = request;
  ...
  Future<int> finalizeBillingAgreementUsingPOST({ FinalizeBillingAgreementRequest request }) async {
    Object postBody = request;
  ...
  Future finalizeCheckoutUsingPOST({ FinalizePayPalPaymentRequest request }) async {
    Object postBody = request;
