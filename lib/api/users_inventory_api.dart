...
class UsersInventoryApi {
  ...
  ///
  /// 
  Future<PageResource«UserInventoryResource»> getUserInventories(int id, { bool inactive, int size, int page, String filterItemName, int filterMinDate, int filterMaxDate }) async {
    Object postBody = null;
