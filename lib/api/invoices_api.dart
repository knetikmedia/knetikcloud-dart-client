...
class InvoicesApi {
  ...
  Future<PageResource«InvoiceResource»> getInvoiceHistoryUsingGET({ int filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterCreatedDate, int size, int page, String order }) async {
  ...
  ///
  /// 
  Future<PageResource«InvoiceLogEntry»> getLogsUsingGET(int id, { int size, int page }) async {
    Object postBody = null;
