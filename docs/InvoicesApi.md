...
# **getInvoices**
> PageResource«InvoiceResource» getInvoices(filterUser, filterEmail, filterFulfillmentStatus, filterPaymentStatus, filterItemName, filterExternalRef, filterCreatedDate, size, page, order)
...
try { 
    var result = api_instance.getInvoices(filterUser, filterEmail, filterFulfillmentStatus, filterPaymentStatus, filterItemName, filterExternalRef, filterCreatedDate, size, page, order);
    print(result);
} catch (e) {
