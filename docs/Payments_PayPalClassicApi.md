# swagger.api.Payments_PayPalClassicApi
...
var api_instance = new Payments_PayPalClassicApi();
...
try { 
    ...
    print("Exception when calling Payments_PayPalClassicApi->createPayPalBillingAgreementUrl: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Payments_PayPalClassicApi->createPayPalExpressCheckout: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Payments_PayPalClassicApi->finalizePayPalBillingAgreement: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Payments_PayPalClassicApi->finalizePayPalCheckout: $e\n");
}
```
