...
class DevicesApi {
  ...
  Future<Page«DeviceResource»> getDevicesUsingGET({ String filterMake, String filterModel, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«DeviceResource»') as Page«DeviceResource» ;
    } else {
      return null;
    }
  }
