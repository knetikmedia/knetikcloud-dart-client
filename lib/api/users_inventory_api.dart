...
class UsersInventoryApi {
  ...
  Future<ItemTemplateResource> createTemplateUsingPOST3({ ItemTemplateResource template }) async {
  ...
  Future deleteEntitlementTemplateUsingDELETE(String id, { String cascade }) async {
  ...
  ///
  /// 
  Future<PageResource«EntitlementItem»> getCurrenciesUsingGET1({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<ItemTemplateResource> getEntitlementTemplateUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«ItemTemplateResource»> getEntitlementTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserInventoryResource»> getInventoryListUsingGET({ bool inactive, int size, int page, String filterItemName, String filterUsername, String filterGroup, String filterDate }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserInventoryResource»> getUserInventoryListUsingGET(int id, { bool inactive, int size, int page, String filterItemName, int filterMinDate, int filterMaxDate }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserItemLogResource»> getUserInventoryLogUsingGET(String userId, int id, { int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future grantEntitlementUsingPOST(int userId, EntitlementGrantRequest grantRequest) async {
  ...
  ///
  /// 
  Future updateTemplateUsingPUT3(String id, { ItemTemplateResource template }) async {
    Object postBody = template;
