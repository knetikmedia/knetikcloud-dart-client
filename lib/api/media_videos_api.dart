...
class MediaVideosApi {
  ...
  ///
  /// 
  Future<CommentResource> addCommentUsingPOST1(int videoId, { CommentResource commentResource }) async {
  ...
  ///
  /// 
  Future addContributorUsingPOST(int videoId, { ContributionResource contributionResource }) async {
  ...
  ///
  /// 
  Future<DispositionResource> addDispositionUsingPOST1(int videoId, { DispositionResource dispositionResource }) async {
  ...
  ///
  /// 
  Future addFlagUsingPOST(int videoId, { String reason }) async {
  ...
  ///
  /// 
  Future<VideoRelationshipResource> addRelatedUsingPOST(int videoId, { VideoRelationshipResource videoRelationshipResource }) async {
  ...
  ///
  /// 
  Future<VideoResource> addVideoUsingPOST({ VideoResource videoResource }) async {
  ...
  Future addWhitelistUsingPOST(int id, { int userId }) async {
  ...
  ///
  /// 
  Future deleteCommentUsingDELETE1(int videoId, int id) async {
  ...
  ///
  /// 
  Future deleteDispositionUsingDELETE1(int dispositionId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future deleteFlagUsingDELETE(int videoId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future deleteRelationshipUsingDELETE1(int videoId, int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future deleteVideoUsingDELETE(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«CommentResource»> getCommentsUsingGET1(int videoId, { int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«CommentResource»') as Page«CommentResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«DispositionResource»> getDispositionsUsingGET1(int videoId, { int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«DispositionResource»') as Page«DispositionResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«VideoRelationshipResource»> getRelatedUsingGET(int videoId, { int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«VideoRelationshipResource»') as Page«VideoRelationshipResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«VideoResource»> getUserVideosUsingGET(int userId, { bool excludeFlagged, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«VideoResource»') as Page«VideoResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<VideoResource> getVideoUsingGET(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future removeContributorUsingDELETE(int videoId, int id) async {
    Object postBody = null;
  ...
  Future removeWhitelistUsingDELETE(int videoId, int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateCommentUsingPUT1(int videoId, int id, { String content }) async {
  ...
  ///
  /// 
  Future updateRelationshipUsingPUT1(int videoId, int relationshipId, { String details }) async {
  ...
  ///
  /// 
  Future updateVideoUsingPUT(int id, { VideoResource videoResource }) async {
    Object postBody = videoResource;
  ...
  ///
  /// 
  Future viewVideoUsingPOST(int id) async {
    Object postBody = null;
