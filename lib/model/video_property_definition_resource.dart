...
/* If provided, the minimum width of the video */
  ...
  @override
  String toString()  {
    return 'VideoPropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, fileType=$fileType, maxHeight=$maxHeight, maxLength=$maxLength, maxWidth=$maxWidth, minHeight=$minHeight, minLength=$minLength, minWidth=$minWidth, ]';
  }
