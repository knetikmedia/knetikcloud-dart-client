...
class AuthRolesApi {
  ...
  ///
  /// 
  Future setClientRoles(String clientKey, { List<String> rolesList }) async {
  ...
  ///
  /// 
  Future setPermissionsForRole(String role, { List<String> permissionsList }) async {
  ...
  ///
  /// 
  Future setUserRoles(int userId, { List<String> rolesList }) async {
    Object postBody = rolesList;
  ...
  ///
  /// 
  Future updateRole(String role, { RoleResource roleResource }) async {
    Object postBody = roleResource;
