...
try { 
    api_instance.deleteGroupMemberUsingDELETE(uniqueName, userId);
} catch (e) {
    print("Exception when calling UsersGroupsApi->deleteGroupMemberUsingDELETE: $e\n");
}
```
...
try { 
    api_instance.deleteGroupUsingDELETE(uniqueName);
} catch (e) {
...
try { 
    var result = api_instance.getGroupListUsingGET(userId);
    print(result);
} catch (e) {
    print("Exception when calling UsersGroupsApi->getGroupListUsingGET: $e\n");
}
```
...
try { 
    var result = api_instance.getGroupMemberUsingGET(uniqueName, userId);
    print(result);
} catch (e) {
    print("Exception when calling UsersGroupsApi->getGroupMemberUsingGET: $e\n");
}
```
...
> PageResource«TemplateResource» getGroupTemplatesUsingGET(size, page, order)
...
> PageResource«GroupMemberResource» searchGroupsUsingGET(uniqueName, size, page, order)
...
> PageResource«GroupResource» searchGroupsUsingGET1(size, page, order)
