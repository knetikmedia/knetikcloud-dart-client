...
> Page«ChallengeEventResource» getChallengeEventssUsingGET(filterStartDateMin, filterStartDateMax, filterEndDateMin, filterEndDateMax, filterCampaigns, filterChallenge, size, page, order)
...
var api_instance = new CampaignsChallengesApi();
var filterStartDateMin = 789; // int | events starting after this date, unix timestamp in seconds
var filterStartDateMax = 789; // int | events starting before this date, unix timestamp in seconds
var filterEndDateMin = 789; // int | events ending after this date, unix timestamp in seconds
var filterEndDateMax = 789; // int | events ending before this date, unix timestamp in seconds
...
try { 
    var result = api_instance.getChallengeEventssUsingGET(filterStartDateMin, filterStartDateMax, filterEndDateMin, filterEndDateMax, filterCampaigns, filterChallenge, size, page, order);
    print(result);
} catch (e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filterStartDateMin** | **int**| events starting after this date, unix timestamp in seconds | [optional] 
 **filterStartDateMax** | **int**| events starting before this date, unix timestamp in seconds | [optional] 
 **filterEndDateMin** | **int**| events ending after this date, unix timestamp in seconds | [optional] 
 **filterEndDateMax** | **int**| events ending before this date, unix timestamp in seconds | [optional] 
