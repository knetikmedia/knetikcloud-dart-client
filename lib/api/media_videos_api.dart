...
class MediaVideosApi {
  ...
  ///
  /// 
  Future<PageResource«CommentResource»> getCommentsUsingGET1(int videoId, { int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«DispositionResource»> getDispositionsUsingGET1(int videoId, { int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«VideoRelationshipResource»> getRelatedUsingGET(int videoId, { int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«VideoResource»> getUserVideosUsingGET(int userId, { bool excludeFlagged, int size, int page }) async {
    Object postBody = null;
