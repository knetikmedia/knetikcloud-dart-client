...
class AuthTokensApi {
  ...
  ///
  /// 
  Future deleteTokenUsingDELETE(String username) async {
    ...
    String path = "/auth/tokens/{username}".replaceAll("{format}","json").replaceAll("{" + "username" + "}", username.toString());
  ...
  ///
  /// 
  Future deleteTokenWithClientIdUsingDELETE(String username, String clientId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<OauthAccessTokenResource> getTokenByUserUsingGET(String username, String clientId) async {
    Object postBody = null;
  ...
  Future<Page«OauthAccessTokenResource»> getTokensUsingGET({ String filterClientId, String filterUsername, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«OauthAccessTokenResource»') as Page«OauthAccessTokenResource» ;
    } else {
      return null;
    }
  }
