...
class ContentArticlesApi {
  ...
  ///
  /// 
  Future updateArticle(String id, { ArticleResource articleResource }) async {
    Object postBody = articleResource;
  ...
  ///
  /// 
  Future updateArticleTemplate(String id, { TemplateResource articleTemplateResource }) async {
    Object postBody = articleTemplateResource;
