...
class InvoicesApi {
  ...
  Future<List<InvoiceResource>> createInvoiceUsingPOST({ InvoiceCreateRequest req }) async {
    Object postBody = req;
  ...
  Future<Page«InvoiceResource»> getInvoiceHistoryUsingGET({ int filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterCreatedDate, int size, int page, String order }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«InvoiceResource»') as Page«InvoiceResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<InvoiceResource> getInvoiceUsingGET(int id, { String postalCode }) async {
    Object postBody = null;
    ...
    Map<String, String> formParams = {};
    if(postalCode != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "postal_code", postalCode));
    }
  ...
  ///
  /// 
  Future<Page«InvoiceLogEntry»> getLogsUsingGET(int id, { int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«InvoiceLogEntry»') as Page«InvoiceLogEntry» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<List<String>> listFulFillmentStatusesUsingGET() async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<List<String>> listPaymentStatusesUsingGET() async {
    Object postBody = null;
  ...
  ///
  /// 
  Future payInvoiceUsingPOST(int id, { PayBySavedMethodRequest request }) async {
  ...
  Future setItemFulfillmentStatusUsingPUT(int id, String sku, String status) async {
  ...
  ///
  /// 
  Future setOrderNotesUsingPUT(int id, { String orderNotes }) async {
  ...
  Future setPaymentStatusUsingPUT(int id, { InvoicePaymentStatusRequest request }) async {
    Object postBody = request;
  ...
  ///
  /// 
  Future updateBillingInfoUsingPUT(int id, { AddressResource billingInfoRequest }) async {
