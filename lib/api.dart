...
part 'api/customerservice_api.dart';
...
part 'model/customer_resource.dart';
...
part 'model/page«achievement_definition_resource».dart';
part 'model/page«aggregate_count_resource».dart';
part 'model/page«aggregate_invoice_report_resource».dart';
part 'model/page«article_resource».dart';
part 'model/page«artist_resource».dart';
part 'model/page«bare_activity_resource».dart';
part 'model/page«bare_challenge_activity_resource».dart';
part 'model/page«billing_report».dart';
part 'model/page«bre_category_resource».dart';
part 'model/page«bre_event_log».dart';
part 'model/page«bre_global_resource».dart';
part 'model/page«bre_rule».dart';
part 'model/page«bre_trigger_resource».dart';
part 'model/page«campaign_resource».dart';
part 'model/page«cart_summary».dart';
part 'model/page«catalog_sale».dart';
part 'model/page«category_resource».dart';
part 'model/page«challenge_event_participant_resource».dart';
part 'model/page«challenge_event_resource».dart';
part 'model/page«challenge_resource».dart';
part 'model/page«client_resource».dart';
part 'model/page«comment_resource».dart';
part 'model/page«config».dart';
part 'model/page«country_tax_resource».dart';
part 'model/page«currency_resource».dart';
part 'model/page«device_resource».dart';
part 'model/page«disposition_resource».dart';
part 'model/page«entitlement_item».dart';
part 'model/page«flag_report_resource».dart';
part 'model/page«forward_log».dart';
part 'model/page«fulfillment_type».dart';
part 'model/page«group_member_resource».dart';
part 'model/page«group_resource».dart';
part 'model/page«import_job_resource».dart';
part 'model/page«invoice_log_entry».dart';
part 'model/page«invoice_resource».dart';
part 'model/page«item_template_resource».dart';
part 'model/page«leveling_resource».dart';
part 'model/page«location_log_resource».dart';
part 'model/page«map«string,object»».dart';
part 'model/page«oauth_access_token_resource».dart';
part 'model/page«permission_resource».dart';
part 'model/page«poll_resource».dart';
part 'model/page«question_resource».dart';
part 'model/page«question_template_resource».dart';
part 'model/page«revenue_country_report_resource».dart';
part 'model/page«revenue_product_report_resource».dart';
part 'model/page«reward_set_resource».dart';
part 'model/page«role_resource».dart';
part 'model/page«saved_address_resource».dart';
part 'model/page«simple_user_resource».dart';
part 'model/page«simple_wallet».dart';
part 'model/page«state_tax_resource».dart';
part 'model/page«store_item_template_resource».dart';
part 'model/page«store_item».dart';
part 'model/page«subscription_resource».dart';
part 'model/page«subscription_template_resource».dart';
part 'model/page«template_resource».dart';
part 'model/page«transaction_resource».dart';
part 'model/page«usage_info».dart';
part 'model/page«user_achievement_group_resource».dart';
part 'model/page«user_action_log».dart';
part 'model/page«user_base_resource».dart';
part 'model/page«user_inventory_resource».dart';
part 'model/page«user_item_log_resource».dart';
part 'model/page«user_leveling_resource».dart';
part 'model/page«user_relationship_resource».dart';
part 'model/page«vendor_resource».dart';
part 'model/page«video_relationship_resource».dart';
part 'model/page«video_resource».dart';
part 'model/page«wallet_total_response».dart';
part 'model/page«wallet_transaction_resource».dart';
part 'model/page«string».dart';
...
part 'model/store_list_request.dart';
