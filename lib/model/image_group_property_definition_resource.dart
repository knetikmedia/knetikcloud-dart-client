...
/* If provided, the minumum width of each image */
  ...
  @override
  String toString()  {
    return 'ImageGroupPropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, fileType=$fileType, maxCount=$maxCount, maxFileSize=$maxFileSize, minCount=$minCount, maxHeight=$maxHeight, maxWidth=$maxWidth, minHeight=$minHeight, minWidth=$minWidth, ]';
  }
