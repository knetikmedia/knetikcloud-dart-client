...
> PageResource«BareChallengeActivityResource» getActivitiesUsingGET1(challengeId, size, page, order)
...
> PageResource«ChallengeEventResource» getChallengeEventssUsingGET(filterStartDate, filterEndDate, filterCampaigns, filterChallenge, size, page, order)
...
> PageResource«TemplateResource» getChallengeTemplatesUsingGET(size, page, order)
...
> PageResource«ChallengeResource» getChallengesUsingGET1(filterTemplate, filterActiveCampaign)
