...
class StoreApi {
  ...
  Future<StoreItemTemplateResource> createItemTemplateUsingPOST({ StoreItemTemplateResource itemTemplateResource }) async {
  ...
  Future<StoreItem> createStoreItemExternalUsingPOST({ StoreItem storeItem }) async {
  ...
  ///
  /// 
  Future deleteItemTemplateUsingDELETE(String id, { String cascade }) async {
  ...
  ///
  /// 
  Future deleteStoreItemUsingDELETE1(int id) async {
    Object postBody = null;
  ...
  ///
  /// Item Templates define a type of item and the properties they have.
  Future<StoreItemTemplateResource> getItemTemplateUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«StoreItemTemplateResource»> getItemTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«StoreItemTemplateResource»') as Page«StoreItemTemplateResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<StoreItem> getStoreItemUsingGET1(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«StoreItem»> getStoreItemsUsingGET({ String filterNameSearch, String filterUniqueKey, bool filterPublished, bool filterDisplayable, String filterStart, String filterEnd, String filterStartDate, String filterStopDate, String filterSku, String filterPrice, String filterTag, String filterItemsByType, String filterBundledSkus, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«StoreItem»') as Page«StoreItem» ;
    } else {
      return null;
    }
  }
  ...
  Future<Page«StoreItem»> getUsingGET2({ StoreListRequest storeListRequest }) async {
  ...
  ///
  /// 
  Future updateItemTemplateUsingPUT(String id, { StoreItemTemplateResource itemTemplateResource }) async {
    Object postBody = itemTemplateResource;
  ...
  ///
  /// 
  Future updateStoreItemExternalUsingPUT(int id, { StoreItem storeItem }) async {
    Object postBody = storeItem;
