...
class StoreShippingApi {
  ...
  Future<ShippingItem> createShippingItem({ ShippingItem shippingItem }) async {
  ...
  Future<ItemTemplateResource> createShippingTemplate({ ItemTemplateResource shippingTemplateResource }) async {
  ...
  ///
  /// 
  Future updateShippingItem(int id, { ShippingItem shippingItem }) async {
    Object postBody = shippingItem;
  ...
  ///
  /// 
  Future updateShippingTemplate(String id, { ItemTemplateResource shippingTemplateResource }) async {
    Object postBody = shippingTemplateResource;
