...
class LogsApi {
  ...
  ///
  /// 
  Future addUserLogUsingPOST({ UserActionLog logEntry }) async {
  ...
  ///
  /// 
  Future<BreEventLog> getEventLogUsingGET(String id) async {
  ...
  ///
  /// 
  Future<Page«BreEventLog»> getEventsLogsUsingGET({ String filterStartDate, String filterEventName, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«BreEventLog»') as Page«BreEventLog» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<ForwardLog> getForwardLogUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«ForwardLog»> getForwardLogsUsingGET({ String filterStartDate, String filterEndDate, int filterStatusCode, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«ForwardLog»') as Page«ForwardLog» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<UserActionLog> getUserLogsUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«UserActionLog»> getUserLogsUsingGET1({ int filterUser, String filterActionName, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«UserActionLog»') as Page«UserActionLog» ;
    } else {
      return null;
    }
  }
