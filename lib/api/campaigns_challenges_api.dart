...
class CampaignsChallengesApi {
  ...
  ///
  /// 
  Future<PageResource«BareChallengeActivityResource»> getActivitiesUsingGET1(int challengeId, { int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«ChallengeEventResource»> getChallengeEventssUsingGET({ String filterStartDate, String filterEndDate, bool filterCampaigns, int filterChallenge, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«TemplateResource»> getChallengeTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«ChallengeResource»> getChallengesUsingGET1({ bool filterTemplate, bool filterActiveCampaign }) async {
    Object postBody = null;
