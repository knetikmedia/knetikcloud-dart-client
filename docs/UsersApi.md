...
> PageResource«TemplateResource» getUserTemplatesUsingGET(size, page, order)
...
# **getUsersUsingGET**
> PageResource«UserBaseResource» getUsersUsingGET(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order)
...
try { 
    var result = api_instance.getUsersUsingGET(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order);
    print(result);
} catch (e) {
