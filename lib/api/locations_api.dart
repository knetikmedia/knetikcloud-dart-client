...
class LocationsApi {
  ...
  ///
  /// 
  Future<List<CityResource>> getCities(String countryCodeIso3, String stateCode) async {
  ...
  ///
  /// 
  Future<List<CountryResource>> getCountries1() async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<List<StateResource>> getCountries2(String countryCodeIso3) async {
    Object postBody = null;
