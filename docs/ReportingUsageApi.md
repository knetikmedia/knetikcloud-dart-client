...
> Page«UsageInfo» getUsageByDayUsingGET(startDate, endDate, combineEndpoints, size, page)
...
[**Page«UsageInfo»**](Page«UsageInfo».md)
...
> Page«UsageInfo» getUsageByHourUsingGET(startDate, endDate, combineEndpoints, size, page)
...
> Page«UsageInfo» getUsageByMinuteUsingGET(startDate, endDate, combineEndpoints, size, page)
...
> Page«UsageInfo» getUsageByMonthUsingGET(startDate, endDate, combineEndpoints, size, page)
...
> Page«UsageInfo» getUsageByYearUsingGET(startDate, endDate, combineEndpoints, size, page)
