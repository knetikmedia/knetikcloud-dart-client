...
class NotificationsApi {
  ...
  Future<NotificationTypeResource> createNotificationType({ NotificationTypeResource notificationType }) async {
    ...
    String path = "/notifications/types".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'NotificationTypeResource') as NotificationTypeResource ;
    } else {
      return null;
    }
  }
  ...
  Future deleteNotificationType(String id) async {
    ...
    // create path and map variables
    String path = "/notifications/types/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<PageResource«NotificationTypeResource»> getNotificationTypes({ int size, int page, String order }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'PageResource«NotificationTypeResource»') as PageResource«NotificationTypeResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<NotificationUserTypeResource> getUserNotificationInfo(String typeId, String userId) async {
    ...
    // verify required params are set
    if(typeId == null) {
     throw new ApiException(400, "Missing required param: typeId");
    }
    if(userId == null) {
    ...
    // create path and map variables
    String path = "/users/{user_id}/notifications/types/{type_id}".replaceAll("{format}","json").replaceAll("{" + "type_id" + "}", typeId.toString()).replaceAll("{" + "user_id" + "}", userId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'NotificationUserTypeResource') as NotificationUserTypeResource ;
    } else {
      return null;
    }
  }
  ...
  Future<PageResource«NotificationUserTypeResource»> getUserNotificationInfoList(String userId, { int size, int page, String order }) async {
    ...
    // create path and map variables
    String path = "/users/{user_id}/notifications/types".replaceAll("{format}","json").replaceAll("{" + "user_id" + "}", userId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'PageResource«NotificationUserTypeResource»') as PageResource«NotificationUserTypeResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<PageResource«UserNotificationResource»> getUserNotifications(String id, { String filterStatus, int size, int page, String order }) async {
    ...
    // create path and map variables
    String path = "/users/{id}/notifications".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'PageResource«UserNotificationResource»') as PageResource«UserNotificationResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<NotificationResource> sendNotification({ NotificationResource notification }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'NotificationResource') as NotificationResource ;
    } else {
      return null;
    }
  }
  ...
  Future setUserNotificationStatus(String userId, String notificationId, { UserNotificationStatusWrapper notification }) async {
    ...
    // create path and map variables
    String path = "/users/{user_id}/notifications/{notification_id}/status".replaceAll("{format}","json").replaceAll("{" + "user_id" + "}", userId.toString()).replaceAll("{" + "notification_id" + "}", notificationId.toString());
  ...
  Future silenceDirectNotifications(String typeId, String userId, ValueWrapper«boolean» silenced) async {
    ...
    if(silenced == null) {
     throw new ApiException(400, "Missing required param: silenced");
    }

    // create path and map variables
    String path = "/users/{user_id}/notifications/types/{type_id}/silenced".replaceAll("{format}","json").replaceAll("{" + "type_id" + "}", typeId.toString()).replaceAll("{" + "user_id" + "}", userId.toString());
