...
class MessagingApi {
  ...
  Future<Map<String, String>> compileMessageTemplate({ MessageTemplateBulkRequest request }) async {
    Object postBody = request;

    // verify required params are set

    // create path and map variables
    String path = "/messaging/templates/compilations".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Map<String, String>') as Map<String, String> ;
    } else {
      return null;
    }
  }
  ...
  Future<MessageTemplateResource> createMessageTemplate({ MessageTemplateResource messageTemplate }) async {
    Object postBody = messageTemplate;

    // verify required params are set

    // create path and map variables
    String path = "/messaging/templates".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'MessageTemplateResource') as MessageTemplateResource ;
    } else {
      return null;
    }
  }
  ...
  Future deleteMessageTemplate(String id) async {
    ...
    // create path and map variables
    String path = "/messaging/templates/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<PageResource«MessageTemplateResource»> getMessageTemplates({ String filterTagset, String filterTagIntersection, String filterTagExclusion, int size, int page, String order }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'PageResource«MessageTemplateResource»') as PageResource«MessageTemplateResource» ;
    } else {
      return null;
    }
  }
  ...
  Future sendMessage({ MessageResource messageResource }) async {
    ...
    // create path and map variables
    String path = "/messaging/message".replaceAll("{format}","json");
  ...
  ///
  /// &lt;b&gt;Permissions Needed:&lt;/b&gt; MESSAGING_ADMIN
  Future sendRawEmail({ RawEmailResource rawEmailResource }) async {
  ...
  Future sendRawPush({ RawPushResource rawPushResource }) async {
    Object postBody = rawPushResource;

    // verify required params are set

    // create path and map variables
    String path = "/messaging/raw-push".replaceAll("{format}","json");
  ...
  Future sendRawSMS({ RawSMSResource rawSMSResource }) async {
  ...
  ///
  /// &lt;b&gt;Permissions Needed:&lt;/b&gt; MESSAGING_ADMIN
  Future sendTemplatedEmail({ TemplateEmailResource messageResource }) async {
    Object postBody = messageResource;
  ...
  Future sendTemplatedPush({ TemplatePushResource templatePushResource }) async {
    Object postBody = templatePushResource;

    // verify required params are set

    // create path and map variables
    String path = "/messaging/templated-push".replaceAll("{format}","json");
  ...
  Future sendTemplatedSMS({ TemplateSMSResource templateSMSResource }) async {
  ...
  Future sendWebsocket({ WebsocketMessageResource websocketResource }) async {
    Object postBody = websocketResource;

    // verify required params are set

    // create path and map variables
    String path = "/messaging/websocket-message".replaceAll("{format}","json");
