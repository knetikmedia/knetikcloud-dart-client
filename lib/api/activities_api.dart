...
class ActivitiesApi {
  ...
  ///
  /// 
  Future<PageResource«BareActivityResource»> getActivities({ bool filterTemplate, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateActivity(int id, { ActivityResource activityResource }) async {
    Object postBody = activityResource;
  ...
  Future updateActivityOccurrence(int activityOccurrenceId, { String activityCccurrenceStatus }) async {
