...
# **getUsers**
> PageResource«UserBaseResource» getUsers(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order)
...
try { 
    var result = api_instance.getUsers(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order);
    print(result);
} catch (e) {
...
try { 
    api_instance.updateUserTemplate(id, userTemplateResource);
} catch (e) {
