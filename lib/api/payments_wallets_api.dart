...
class PaymentsWalletsApi {
  ...
  ///
  /// 
  Future<PageResource«WalletTransactionResource»> getWalletTransactions({ int filterInvoice, String filterType, int filterMaxDate, int filterMinDate, String filterSign, int filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, int size, int page, String order }) async {
    Object postBody = null;
