...
class DevicesApi {
  ...
  ///
  /// 
  Future<DeviceResource> addDeviceUsers(List<SimpleUserResource> userResources, int id) async {
  ...
  ///
  /// 
  Future deleteDeviceUser(int id, int userId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future deleteDeviceUsers(int id, { String filterId }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<DeviceResource> getDevice(int id) async {
    Object postBody = null;
  ...
  Future<PageResource«DeviceResource»> getDevices({ String filterMake, String filterModel, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<DeviceResource> updateDevice(DeviceResource device, int id) async {
    Object postBody = device;
