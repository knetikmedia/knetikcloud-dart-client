...
> PageResource«AggregateInvoiceReportResource» getDailyInvoicesUsingGET(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate)
