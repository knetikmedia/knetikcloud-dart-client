...
class StoreSubscriptionsApi {
  ...
  ///
  /// 
  Future<Page«SubscriptionTemplateResource»> getSubscriptionTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«SubscriptionTemplateResource»') as Page«SubscriptionTemplateResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«BillingReport»> listBillingReportsUsingGET({ int size, int page }) async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/subscriptions/reports".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«BillingReport»') as Page«BillingReport» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<Page«SubscriptionResource»> listSubscriptionsUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«SubscriptionResource»') as Page«SubscriptionResource» ;
    } else {
      return null;
    }
  }
