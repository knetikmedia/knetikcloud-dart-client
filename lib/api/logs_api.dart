...
class LogsApi {
  ...
  ///
  /// 
  Future<PageResource«BreEventLog»> getBREEventLogs({ String filterStartDate, String filterEventName, int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserActionLog»> getUserLogs({ int filterUser, String filterActionName, int size, int page }) async {
    Object postBody = null;
