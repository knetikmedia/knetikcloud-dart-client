...
/* The users currently using the device */
  ...
  @override
  String toString()  {
    return 'DeviceResource[authorization=$authorization, condition=$condition, createdDate=$createdDate, data=$data, description=$description, deviceType=$deviceType, id=$id, location=$location, macAddress=$macAddress, make=$make, model=$model, name=$name, os=$os, serial=$serial, status=$status, updatedDate=$updatedDate, user=$user, users=$users, ]';
  }
