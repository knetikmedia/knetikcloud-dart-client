...
class ReportingChallengesApi {
  ...
  Future<PageResource«ChallengeEventParticipantResource»> getChallengeEventLeaderboardUsingGET({ int filterEvent }) async {
  ...
  Future<PageResource«ChallengeEventParticipantResource»> getChallengeEventParticipantsUsingGET({ int filterEvent }) async {
    Object postBody = null;
