...
class BRERuleEngineTriggersApi {
  ...
  ///
  /// 
  Future<PageResource«BreTriggerResource»> getBRETriggers({ bool filterSystem, String filterCategory, String filterName, int size, int page }) async {
    Object postBody = null;
  ...
  Future updateBRETrigger(String eventName, { BreTriggerResource breTriggerResource }) async {
    Object postBody = breTriggerResource;
