...
# **getUserInventories**
> PageResource«UserInventoryResource» getUserInventories(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate)
...
try { 
    var result = api_instance.getUserInventories(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
    print(result);
} catch (e) {
