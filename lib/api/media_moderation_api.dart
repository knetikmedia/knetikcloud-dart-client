...
class MediaModerationApi {
  ...
  ///
  /// 
  Future getFlagReportUsingGET(int id) async {
  ...
  Future<Page«FlagReportResource»> getFlagsReportUsingGET({ bool excludeResolved, String filterContext, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«FlagReportResource»') as Page«FlagReportResource» ;
    } else {
      return null;
    }
  }
  ...
  Future setFlagResolutionUsingPUT(int id, { FlagReportResource flagReportResource }) async {
