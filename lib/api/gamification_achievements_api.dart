...
class GamificationAchievementsApi {
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get a single poll&#39; to retrieve the full resource with assets for a given item as needed.
  Future<PageResource«UserAchievementGroupResource»> getUserAchievementsProgress(int userId, { bool filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  Future<PageResource«UserAchievementGroupResource»> getUsersAchievementProgress(String achievementName, { bool filterAchievementDerived, String filterAchievementTagset, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
  Future<PageResource«UserAchievementGroupResource»> getUsersAchievementsProgress({ bool filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  Future updateAchievement(String name, { AchievementDefinitionResource achievement }) async {
    Object postBody = achievement;
  ...
  ///
  /// 
  Future updateAchievementTemplate(String id, { TemplateResource template }) async {
    Object postBody = template;
