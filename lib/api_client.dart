  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'Page«AggregateCountResource»':
          return dson.map(value, new Page«AggregateCountResource»());
        case 'Page«AggregateInvoiceReportResource»':
          return dson.map(value, new Page«AggregateInvoiceReportResource»());
        ...
        case 'Page«ChallengeEventParticipantResource»':
          return dson.map(value, new Page«ChallengeEventParticipantResource»());
        ...
        case 'Page«GroupMemberResource»':
          return dson.map(value, new Page«GroupMemberResource»());
        case 'Page«GroupResource»':
          return dson.map(value, new Page«GroupResource»());
        ...
        case 'Page«LevelingResource»':
          return dson.map(value, new Page«LevelingResource»());
        ...
        case 'Page«RevenueCountryReportResource»':
          return dson.map(value, new Page«RevenueCountryReportResource»());
        case 'Page«RevenueProductReportResource»':
          return dson.map(value, new Page«RevenueProductReportResource»());
        ...
        case 'Page«StoreItemTemplateResource»':
          return dson.map(value, new Page«StoreItemTemplateResource»());
        case 'Page«StoreItem»':
        ...
        case 'Page«UsageInfo»':
          return dson.map(value, new Page«UsageInfo»());
        case 'Page«UserAchievementGroupResource»':
          return dson.map(value, new Page«UserAchievementGroupResource»());
        ...
        case 'Page«UserLevelingResource»':
          return dson.map(value, new Page«UserLevelingResource»());
        case 'Page«UserRelationshipResource»':
          return dson.map(value, new Page«UserRelationshipResource»());
