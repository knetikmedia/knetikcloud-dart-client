...
# **getLevelsUsingGET**
> Page«LevelingResource» getLevelsUsingGET(filterName, size, page, order)
...
[**Page«LevelingResource»**](Page«LevelingResource».md)
...
> Page«UserLevelingResource» getUserLevelsUsingGET(userId)
...
[**Page«UserLevelingResource»**](Page«UserLevelingResource».md)
