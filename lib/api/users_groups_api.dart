...
class UsersGroupsApi {
  ...
  ///
  /// 
  Future updateGroupTemplate(String id, { TemplateResource groupTemplateResource }) async {
    Object postBody = groupTemplateResource;
  ...
  ///
  /// 
  Future<PageResource«GroupResource»> updateGroups({ int size, int page, String order }) async {
    Object postBody = null;
