...
class UtilSecurityApi {
  ...
  Future<Page«LocationLogResource»> getUserLocationLogUsingGET({ int userId }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«LocationLogResource»') as Page«LocationLogResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<TokenDetailsResource> userUsingGET({ Authentication authentication }) async {
    Object postBody = authentication;
