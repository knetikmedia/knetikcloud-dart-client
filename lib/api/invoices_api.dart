...
class InvoicesApi {
  ...
  Future<PageResource«InvoiceResource»> getInvoices({ int filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterExternalRef, String filterCreatedDate, String filterVendorIds, String filterCurrency, String filterShippingStateName, String filterShippingCountryName, double filterShipping, String filterVendorName, String filterSku, int size, int page, String order }) async {
    Object postBody = null;
