...
class CampaignsChallengesApi {
  ...
  ///
  /// 
  Future<PageResource«ChallengeResource»> getChallenges({ bool filterTemplate, bool filterActiveCampaign, String filterStartDate, String filterEndDate, int size, int page, String order }) async {
    Object postBody = null;
