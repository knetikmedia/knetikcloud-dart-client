...
class UsersInventoryApi {
  ...
  ///
  /// 
  Future<Page«ItemTemplateResource»> getEntitlementTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«UserInventoryResource»> getInventoryListUsingGET({ bool inactive, int size, int page, String filterItemName, String filterUsername, String filterGroup, String filterDate }) async {
    Object postBody = null;
