# swagger.api.Payments_StripeApi
...
var api_instance = new Payments_StripeApi();
...
try { 
    ...
    print("Exception when calling Payments_StripeApi->createStripePaymentMethod: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling Payments_StripeApi->payStripeInvoice: $e\n");
}
```
