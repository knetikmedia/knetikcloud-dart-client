...
# **getListUsingGET1**
> PageResource«ImportJobResource» getListUsingGET1(filterVendor, filterCategory, filterName, filterStatus, size, page, order)
...
> PageResource«QuestionTemplateResource» getQuestionTemplatesUsingGET(size, page, order)
...
> PageResource«QuestionResource» getQuestionsUsingGET(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId)
