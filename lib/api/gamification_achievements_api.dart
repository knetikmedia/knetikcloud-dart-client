...
class GamificationAchievementsApi {
  ...
  ///
  /// 
  Future<Page«TemplateResource»> getAchievementTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«AchievementDefinitionResource»> getAchievementsUsingGET({ String filterTagset, String filterName, bool filterHidden, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«AchievementDefinitionResource»') as Page«AchievementDefinitionResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<Page«UserAchievementResource»> getAllUserProgressForAchievementUsingGET(String achievementName, { String filterAchievementTagset, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«UserAchievementResource»') as Page«UserAchievementResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
  Future<Page«UserAchievementResource»> getAllUserProgressUsingGET({ String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  Future<UserAchievementResource> getUserProgressForAchievementUsingGET(int userId, String achievementName) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'UserAchievementResource') as UserAchievementResource ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get a single poll&#39; to retrieve the full resource with assets for a given item as needed.
  Future<Page«UserAchievementResource»> getUserProgressUsingGET(int userId, { String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  Future<UserAchievementResource> updateProgressUsingPUT(int userId, String achievementName, { AchievementProgressUpdateRequest request }) async {
