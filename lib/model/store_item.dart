...
/* The vendor who provides the item */
  ...
  @override
  String toString()  {
    return 'StoreItem[additionalProperties=$additionalProperties, behaviors=$behaviors, category=$category, createdDate=$createdDate, id=$id, longDescription=$longDescription, name=$name, shortDescription=$shortDescription, sort=$sort, tags=$tags, template=$template, typeHint=$typeHint, uniqueKey=$uniqueKey, updatedDate=$updatedDate, displayable=$displayable, geoCountryList=$geoCountryList, geoPolicyType=$geoPolicyType, shippingTier=$shippingTier, skus=$skus, storeEnd=$storeEnd, storeStart=$storeStart, vendorId=$vendorId, ]';
  }
