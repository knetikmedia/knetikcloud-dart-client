...
> Page«TemplateResource» getPollTemplatesUsingGET(size, page, order)
...
# **getPollsUsingGET**
> Page«PollResource» getPollsUsingGET(filterCategory, filterTagset, filterText, size, page, order)
...
[**Page«PollResource»**](Page«PollResource».md)
