...
class UsersFriendshipsApi {
  ...
  Future addFriendUsingPOST(String userId, int id) async {
  ...
  Future connectUsingTokenUsingPOST(String userId, { String token }) async {
  ...
  ///
  /// 
  Future<Page«SimpleUserResource»> getFriendsUsingGET(String userId, { int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«SimpleUserResource»') as Page«SimpleUserResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<String> getInviteTokenUsingGET(String userId) async {
    Object postBody = null;
  ...
  Future<Page«SimpleUserResource»> getInvitesUsingGET(String userId, { int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future removeFriendUsingDELETE(String userId, int id) async {
    Object postBody = null;
