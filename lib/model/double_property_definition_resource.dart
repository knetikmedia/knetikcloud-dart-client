...
/* If provided, the minimum value */
  ...
  @override
  String toString()  {
    return 'DoublePropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, max=$max, min=$min, ]';
  }
