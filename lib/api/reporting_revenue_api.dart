...
class ReportingRevenueApi {
  ...
  Future<Page«RevenueCountryReportResource»> executiveRevenueCountrySalesUsingGET(String currencyCode, { int startDate, int endDate, int size, int page }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«RevenueCountryReportResource»') as Page«RevenueCountryReportResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<RevenueReportResource> executiveRevenueItemSalesUsingGET(String currencyCode, { int startDate, int endDate }) async {
    Object postBody = null;
  ...
  Future<Page«RevenueProductReportResource»> executiveRevenueProductSalesUsingGET(String currencyCode, { int startDate, int endDate, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«RevenueProductReportResource»') as Page«RevenueProductReportResource» ;
    } else {
      return null;
    }
  }
  ...
  Future<RevenueReportResource> executiveRevenueRefundsUsingGET(String currencyCode, { int startDate, int endDate }) async {
    Object postBody = null;
  ...
  Future<RevenueReportResource> executiveRevenueSubscriptionSalesUsingGET(String currencyCode, { int startDate, int endDate }) async {
    Object postBody = null;
