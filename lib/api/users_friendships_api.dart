...
class UsersFriendshipsApi {
  ...
  ///
  /// 
  Future<PageResource«SimpleUserResource»> getFriendsUsingGET(String userId, { int size, int page, String order }) async {
    Object postBody = null;
  ...
  Future<PageResource«SimpleUserResource»> getInvitesUsingGET(String userId, { int size, int page, String order }) async {
    Object postBody = null;
