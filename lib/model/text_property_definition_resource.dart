...
/* If provided, the maximum length of the text */
  ...
  @override
  String toString()  {
    return 'TextPropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, maxLength=$maxLength, ]';
  }
