...
class CampaignsChallengesApi {
  ...
  ///
  /// 
  Future<PageResource«ChallengeResource»> getChallenges({ bool filterTemplate, bool filterActiveCampaign }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateChallengeActivity(int activityId, int challengeId, { ChallengeActivityResource challengeActivityResource }) async {
    Object postBody = challengeActivityResource;
  ...
  ///
  /// 
  Future updateChallengeTemplate(String id, { TemplateResource challengeTemplateResource }) async {
    Object postBody = challengeTemplateResource;
