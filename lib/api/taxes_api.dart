...
class TaxesApi {
  ...
  ///
  /// 
  Future createCountryTax({ CountryTaxResource taxResource }) async {
  ...
  ///
  /// 
  Future createStateTax(String countryCodeIso3, { StateTaxResource taxResource }) async {
    Object postBody = taxResource;
  ...
  ///
  /// 
  Future updateCountryTax(String countryCodeIso3, { CountryTaxResource taxResource }) async {
    Object postBody = taxResource;
  ...
  ///
  /// 
  Future updateStateTax(String countryCodeIso3, String stateCode, { StateTaxResource taxResource }) async {
    Object postBody = taxResource;
