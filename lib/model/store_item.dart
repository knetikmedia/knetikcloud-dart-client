...
/* The vendor who provides the item */
  ...
  @override
  String toString()  {
    return 'StoreItem[additionalProperties=$additionalProperties, behaviors=$behaviors, category=$category, createdDate=$createdDate, displayable=$displayable, geoCountryList=$geoCountryList, geoPolicyType=$geoPolicyType, id=$id, longDescription=$longDescription, name=$name, shippingTier=$shippingTier, shortDescription=$shortDescription, skus=$skus, sort=$sort, storeEnd=$storeEnd, storeStart=$storeStart, tags=$tags, template=$template, typeHint=$typeHint, uniqueKey=$uniqueKey, updatedDate=$updatedDate, vendorId=$vendorId, ]';
  }
