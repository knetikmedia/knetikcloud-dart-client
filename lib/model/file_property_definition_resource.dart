...
/* If provided, the maximum allowed file size in bytes */
  ...
  @override
  String toString()  {
    return 'FilePropertyDefinitionResource[description=$description, fieldList=$fieldList, friendlyName=$friendlyName, name=$name, optionLabelPath=$optionLabelPath, optionValuePath=$optionValuePath, optionsUrl=$optionsUrl, required=$required, type=$type, fileType=$fileType, maxFileSize=$maxFileSize, ]';
  }
