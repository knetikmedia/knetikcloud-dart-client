...
try { 
    api_instance.createCountryTax(taxResource);
} catch (e) {
...
try { 
    api_instance.createStateTax(countryCodeIso3, taxResource);
} catch (e) {
...
try { 
    api_instance.updateCountryTax(countryCodeIso3, taxResource);
} catch (e) {
...
try { 
    api_instance.updateStateTax(countryCodeIso3, stateCode, taxResource);
} catch (e) {
