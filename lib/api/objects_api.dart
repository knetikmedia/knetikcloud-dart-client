...
class ObjectsApi {
  ...
  ObjectsApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<ObjectResource> createObjectItem(String templateId, { bool cascade, ObjectResource objectItem }) async {
    ...
    String path = "/objects/{template_id}".replaceAll("{format}","json").replaceAll("{" + "template_id" + "}", templateId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'ObjectResource') as ObjectResource ;
    } else {
      return null;
    }
  }
  ...
  Future<ItemTemplateResource> createObjectTemplate({ ItemTemplateResource template }) async {
    ...
    // create path and map variables
    String path = "/objects/templates".replaceAll("{format}","json");
  ...
  Future deleteObjectTemplate(String id, { String cascade }) async {
    ...
    // create path and map variables
    String path = "/objects/templates/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<PageResource«ObjectResource»> getObjectItems(String templateId, { int size, int page, String order }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'PageResource«ObjectResource»') as PageResource«ObjectResource» ;
    } else {
      return null;
    }
  }
