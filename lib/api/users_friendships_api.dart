...
class UsersFriendshipsApi {
  ...
  ///
  /// 
  Future<PageResource«SimpleUserResource»> getFriends(String userId, { int size, int page, String order }) async {
    Object postBody = null;
  ...
  Future<PageResource«SimpleUserResource»> getInvites(String userId, { int size, int page, String order }) async {
    Object postBody = null;
