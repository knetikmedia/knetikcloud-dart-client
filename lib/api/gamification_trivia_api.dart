...
class GamificationTriviaApi {
  ...
  ///
  /// 
  Future<PageResource«QuestionResource»> getQuestions({ int size, int page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, bool filterPublished, int filterImportId }) async {
    Object postBody = null;
  ...
  Future<Collection«string»> searchQuestionTags({ String filterSearch, String filterCategory, int filterImportId }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateQuestionTemplate(String id, { QuestionTemplateResource questionTemplateResource }) async {
    Object postBody = questionTemplateResource;
