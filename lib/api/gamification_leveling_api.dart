...
class GamificationLevelingApi {
  ...
  ///
  /// 
  Future<UserLevelingResource> getUserLevel(int userId, String name) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<PageResource«UserLevelingResource»> getUserLevels(int userId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateLevel(String name, { LevelingResource newLevel }) async {
  ...
  Future updateUserLevel(int userId, String name, { int progress }) async {
