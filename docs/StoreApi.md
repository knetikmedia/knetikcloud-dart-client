...
# **getUsingGET2**
> PageResource«StoreItem» getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly)
...
try { 
    var result = api_instance.getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly);
    print(result);
} catch (e) {
