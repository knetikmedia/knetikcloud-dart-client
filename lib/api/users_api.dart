...
class UsersApi {
  ...
  ///
  /// 
  Future addTagUsingPOST1(int userId, String tag) async {
    Object postBody = tag;
  ...
  Future<TemplateResource> createUserTemplateUsingPOST({ TemplateResource userTemplateResource }) async {
  ...
  Future deleteUserTemplateUsingDELETE(String id, { String cascade }) async {
  ...
  Future doPasswordResetUsingPUT(int id, { NewPasswordRequest newPasswordRequest }) async {
  ...
  ///
  /// 
  Future<List<String>> getTagsUsingGET3(int userId) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<TemplateResource> getUserTemplateUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«TemplateResource»> getUserTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  Future<UserResource> getUserUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// Additional private info is included as USERS_ADMIN
  Future<Page«UserBaseResource»> getUsersUsingGET({ String filterRole, String filterDisplayname, String filterEmail, String filterFirstname, String filterFullname, String filterLastname, String filterUsername, String filterTag, String filterGroup, int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«UserBaseResource»') as Page«UserBaseResource» ;
    } else {
      return null;
    }
  }
  ...
  Future initiatePasswordResetUsingPOST(int id) async {
    Object postBody = null;
  ...
  Future<UserResource> registerUserUsingPOST({ UserResource userResource }) async {
  ...
  ///
  /// 
  Future removeTagUsingDELETE1(int userId, String tag) async {
    Object postBody = null;
  ...
  ///
  /// Password should be in plain text and will be encrypted on receipt. Use SSL for security.
  Future setPasswordUsingPUT(int id, { String password }) async {
  ...
  ///
  /// 
  Future updateUserTemplateUsingPUT(String id, { TemplateResource userTemplateResource }) async {
    Object postBody = userTemplateResource;
  ...
  Future updateUserUsingPUT(String id, { UserResource userResource }) async {
    Object postBody = userResource;
