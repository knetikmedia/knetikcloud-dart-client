...
class StoreBundlesApi {
  ...
  Future<BundleItem> createBundleItem({ BundleItem bundleItem }) async {
  ...
  ///
  /// 
  Future updateBundleItem(int id, { BundleItem bundleItem }) async {
    Object postBody = bundleItem;
  ...
  ///
  /// 
  Future updateBundleTemplate(String id, { ItemTemplateResource bundleTemplateResource }) async {
    Object postBody = bundleTemplateResource;
