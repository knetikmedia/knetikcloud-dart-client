...
> Page«AchievementDefinitionResource» getAchievementsUsingGET(filterTagset, filterName, filterHidden, size, page, order)
...
try { 
    var result = api_instance.getAchievementsUsingGET(filterTagset, filterName, filterHidden, size, page, order);
    print(result);
} catch (e) {
...
> Page«UserAchievementResource» getAllUserProgressForAchievementUsingGET(achievementName, filterAchievementTagset, filterAchievementHidden, size, page)
...
try { 
    var result = api_instance.getAllUserProgressForAchievementUsingGET(achievementName, filterAchievementTagset, filterAchievementHidden, size, page);
    print(result);
} catch (e) {
...
[**Page«UserAchievementResource»**](Page«UserAchievementResource».md)
...
> Page«UserAchievementResource» getAllUserProgressUsingGET(filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page)
...
try { 
    var result = api_instance.getAllUserProgressUsingGET(filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
    print(result);
} catch (e) {
...
> Page«UserAchievementResource» getUserProgressUsingGET(userId, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page)
...
try { 
    var result = api_instance.getUserProgressUsingGET(userId, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
    print(result);
} catch (e) {
