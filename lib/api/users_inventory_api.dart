...
class UsersInventoryApi {
  ...
  ///
  /// 
  Future<EntitlementItem> createEntitlementItem({ EntitlementItem entitlementItem }) async {
  ...
  ///
  /// 
  Future<PageResource«UserInventoryResource»> getUserInventory1(int id, { bool inactive, int size, int page, String filterItemName, int filterMinDate, int filterMaxDate }) async {
    Object postBody = null;
  ...
  Future getUserInventoryLog1(int userId, int id, { int timestamp }) async {
  ...
  ///
  /// 
  Future<PageResource«UserInventoryResource»> getUsersInventory({ bool inactive, int size, int page, String filterItemName, String filterUsername, String filterGroup, String filterDate }) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future updateEntitlementItem(int entitlementId, { EntitlementItem entitlementItem }) async {
    Object postBody = entitlementItem;
  ...
  ///
  /// 
  Future updateEntitlementTemplate(String id, { ItemTemplateResource template }) async {
    Object postBody = template;
