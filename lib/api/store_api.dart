...
class StoreApi {
  ...
  Future<StoreItem> createStoreItem({ StoreItem storeItem }) async {
  ...
  Future<PageResource«StoreItem»> getStore({ int limit, int page, bool useCatalog, bool ignoreLocation, bool inStockOnly }) async {
    Object postBody = null;
    ...
    if(useCatalog != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "use_catalog", useCatalog));
    }
    if(ignoreLocation != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "ignore_location", ignoreLocation));
    }
    if(inStockOnly != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "in_stock_only", inStockOnly));
    }
  ...
  ///
  /// 
  Future updateItemTemplate(String id, { StoreItemTemplateResource itemTemplateResource }) async {
    Object postBody = itemTemplateResource;
  ...
  ///
  /// 
  Future updateStoreItem(int id, { StoreItem storeItem }) async {
    Object postBody = storeItem;
