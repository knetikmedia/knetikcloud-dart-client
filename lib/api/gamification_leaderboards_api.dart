...
class GamificationLeaderboardsApi {
  ...
  Future<LeaderboardResource> getLeaderboardUsingGET(String contextType, String contextId, { int size, int page }) async {
  ...
  ///
  /// 
  Future<List<String>> getStrategiesUsingGET() async {
    Object postBody = null;
  ...
  ///
  /// The context type identifies the type of entity (i.e., &#39;activity&#39;) being tracked on the leaderboard. The context ID is the unique ID of the actual entity tracked by the leaderboard
  Future<LeaderboardEntryResource> getUserRankUsingGET(String contextType, String contextId, String id) async {
    Object postBody = null;
