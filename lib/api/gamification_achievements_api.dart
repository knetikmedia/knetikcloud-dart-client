...
class GamificationAchievementsApi {
  ...
  ///
  /// 
  Future<Page«AchievementDefinitionResource»> getAchievementsUsingGET({ String filterTagset, String filterName, bool filterHidden, bool filterDerived, int size, int page, String order }) async {
    Object postBody = null;
  ...
  Future<Page«UserAchievementGroupResource»> getAllUserProgressForAchievementUsingGET(String achievementName, { bool filterAchievementDerived, String filterAchievementTagset, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«UserAchievementGroupResource»') as Page«UserAchievementGroupResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
  Future<Page«UserAchievementGroupResource»> getAllUserProgressUsingGET({ bool filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
  ...
  ///
  /// Assets will not be filled in on the resources returned. Use &#39;Get a single poll&#39; to retrieve the full resource with assets for a given item as needed.
  Future<Page«UserAchievementGroupResource»> getUserProgressUsingGET(int userId, { bool filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, bool filterAchievementHidden, int size, int page }) async {
    Object postBody = null;
