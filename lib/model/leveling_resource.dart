...
/* The date the leveling schema was updated */
  ...
  @override
  String toString()  {
    return 'LevelingResource[additionalProperties=$additionalProperties, createdDate=$createdDate, description=$description, name=$name, tiers=$tiers, triggerEventName=$triggerEventName, updatedDate=$updatedDate, ]';
  }
