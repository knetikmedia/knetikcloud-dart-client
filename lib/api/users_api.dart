...
class UsersApi {
  ...
  ///
  /// 
  Future<PageResource«TemplateResource»> getUserTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
  ...
  ///
  /// Additional private info is included as USERS_ADMIN
  Future<PageResource«UserBaseResource»> getUsersUsingGET({ String filterDisplayname, String filterEmail, String filterFirstname, String filterFullname, String filterLastname, String filterUsername, String filterTag, String filterGroup, int size, int page, String order }) async {
    Object postBody = null;
