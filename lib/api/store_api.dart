...
class StoreApi {
  ...
  Future<ItemTemplateResource> createItemTemplateUsingPOST({ ItemTemplateResource itemTemplateResource }) async {
  ...
  ///
  /// Item Templates define a type of item and the properties they have.
  Future<ItemTemplateResource> getItemTemplateUsingGET(String id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Page«ItemTemplateResource»> getItemTemplatesUsingGET({ int size, int page, String order }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Page«ItemTemplateResource»') as Page«ItemTemplateResource» ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future updateItemTemplateUsingPUT(String id, { ItemTemplateResource itemTemplateResource }) async {
    Object postBody = itemTemplateResource;
