...
class MediaModerationApi {
  ...
  ///
  /// 
  Future getModerationReport(int id) async {
  ...
  Future<PageResource«FlagReportResource»> getModerationReports({ bool excludeResolved, String filterContext, int size, int page }) async {
    Object postBody = null;
