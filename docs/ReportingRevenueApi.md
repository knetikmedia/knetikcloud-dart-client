...
> Page«RevenueCountryReportResource» executiveRevenueCountrySalesUsingGET(currencyCode, startDate, endDate, size, page)
...
[**Page«RevenueCountryReportResource»**](Page«RevenueCountryReportResource».md)
...
> Page«RevenueProductReportResource» executiveRevenueProductSalesUsingGET(currencyCode, startDate, endDate, size, page)
...
[**Page«RevenueProductReportResource»**](Page«RevenueProductReportResource».md)
