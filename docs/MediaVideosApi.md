...
> PageResource«CommentResource» getCommentsUsingGET1(videoId, size, page)
...
> PageResource«DispositionResource» getDispositionsUsingGET1(videoId, size, page)
...
# **getRelatedUsingGET**
> PageResource«VideoRelationshipResource» getRelatedUsingGET(videoId, size, page)
...
> PageResource«VideoResource» getUserVideosUsingGET(userId, excludeFlagged, size, page)
...
> PageResource«VideoResource» searchVideosUsingGET(excludeFlagged, filterVideosByUploader, filterCategory, filterTagset, filterVideosByName, filterVideosByContributor, filterVideosByAuthor, filterHasAuthor, filterHasUploader, filterRelatedTo, filterFriends, filterDisposition, size, page, order)
