...
try { 
    var result = api_instance.createShippingItem(shippingItem);
    print(result);
} catch (e) {
    print("Exception when calling StoreShippingApi->createShippingItem: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->createShippingTemplate: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->deleteShippingItem: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->deleteShippingTemplate: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->getShippingItem: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->getShippingTemplate: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling StoreShippingApi->getShippingTemplates: $e\n");
}
```
...
try { 
    api_instance.updateShippingItem(id, shippingItem);
} catch (e) {
    print("Exception when calling StoreShippingApi->updateShippingItem: $e\n");
}
```
...
try { 
    api_instance.updateShippingTemplate(id, shippingTemplateResource);
} catch (e) {
    print("Exception when calling StoreShippingApi->updateShippingTemplate: $e\n");
}
```
