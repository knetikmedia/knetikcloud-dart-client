...
> Page«WalletTotalResponse» getWalletTotalsUsingGET()
...
[**Page«WalletTotalResponse»**](Page«WalletTotalResponse».md)
...
# **getWalletsUsingGET1**
> Page«SimpleWallet» getWalletsUsingGET1(size, page, order)
...
[**Page«SimpleWallet»**](Page«SimpleWallet».md)
...
> Page«WalletTransactionResource» transactionHistoryUsingGET(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order)
...
[**Page«WalletTransactionResource»**](Page«WalletTransactionResource».md)
...
> Page«WalletTransactionResource» userTransactionHistoryUsingGET(userId, currencyCode, filterType, filterMaxDate, filterMinDate, filterSign, size, page, order)
